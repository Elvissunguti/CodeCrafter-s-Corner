...
router.get('/blog/pendingapproval', passport.authenticate('jwt', { session: false }), async (req, res) => {
  try {
...
router.post('/blog/approve/:blogId', passport.authenticate('jwt', { session: false }), async (req, res) => {
  try {
...
router.post('/create/:userId', passport.authenticate('jwt', { session: false }), async (req, res) => {
  try {
...
router.post('/remove/:userId', passport.authenticate('jwt', { session: false }), async (req, res) => {
  try {
    const { userId } = req.params;
...
router.get('/fetch/users', passport.authenticate('jwt', { session: false }), async (req, res) => {
  try {
